...
import { TreeViewTransition } from "@/datahub/components/schema/TreeViewTransition";
import { ellipsisSx } from "@/utils/commonSx";
import { TreeActionDemo } from "./TreeActionDemo";
      ...
      <TreeItem2Root {...getRootProps(other)}>
        ...
        >
          ...
          <Box sx={{ display: "flex", alignItems: "center", position: "relative" }}>
            ...
            {["table", "columns", "indexes"].includes(type) && <TreeActionDemo table={table} />}
          </Box>
        </TreeItem2Content>
        {children && (
          <TreeViewTransition
