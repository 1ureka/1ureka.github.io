var k=Object.defineProperty;var H=(e,t,s)=>t in e?k(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var F=(e,t,s)=>H(e,typeof t!="symbol"?t+"":t,s);import{n as B,v as b,r as W,o as M,j as u,B as S,T as g,P as _,q as O,y as Q,w as z,C as J,x as K}from"./routes-BtBCtlTZ.js";import{i as D,h as G,a as V,R as Y,Q as X,b as Z,E as ee,t as w,d as te,c as se,g as re,f as ae,s as j}from"./forum-CDt4a5Mt.js";import{F as ne}from"./ForumRounded-DF_NgXJO.js";import{Q as oe,a as ie,u as T}from"./useQuery-BcHysvRj.js";var ce=class extends oe{constructor(e,t){super(e,t)}bindMethods(){super.bindMethods(),this.fetchNextPage=this.fetchNextPage.bind(this),this.fetchPreviousPage=this.fetchPreviousPage.bind(this)}setOptions(e,t){super.setOptions({...e,behavior:D()},t)}getOptimisticResult(e){return e.behavior=D(),super.getOptimisticResult(e)}fetchNextPage(e){return this.fetch({...e,meta:{fetchMore:{direction:"forward"}}})}fetchPreviousPage(e){return this.fetch({...e,meta:{fetchMore:{direction:"backward"}}})}createResult(e,t){var x,y;const{state:s}=e,r=super.createResult(e,t),{isFetching:a,isRefetching:n,isError:o,isRefetchError:i}=r,c=(y=(x=s.fetchMeta)==null?void 0:x.fetchMore)==null?void 0:y.direction,l=o&&c==="forward",h=a&&c==="forward",f=o&&c==="backward",p=a&&c==="backward";return{...r,fetchNextPage:this.fetchNextPage,fetchPreviousPage:this.fetchPreviousPage,hasNextPage:V(t,s.data),hasPreviousPage:G(t,s.data),isFetchNextPageError:l,isFetchingNextPage:h,isFetchPreviousPageError:f,isFetchingPreviousPage:p,isRefetchError:i&&!l&&!f,isRefetching:n&&!h&&!p}}};function ue(e,t){return ie(e,ce)}const P=B({cssVariables:{colorSchemeSelector:".mode-%s"},typography:{fontFamily:'Comfortaa, "jf openhuninn", "Noto Sans TC"'},colorSchemes:{light:{palette:{text:{primary:"#000"},primary:{main:"#FF772E",contrastText:"#fff"},secondary:{main:"#2f5d6f"}}},dark:{palette:{primary:{main:"#FF772E",contrastText:"#fff"},secondary:{main:"#2f5d6f"},background:{default:"#222",paper:"#222"}}}},components:{MuiInputBase:{defaultProps:{sx:{"&.Mui-disabled::before":{borderBottomStyle:"solid"}}}}},spacing:"0.5rem"}),Re=()=>{const e=b(P.breakpoints.up("lg")),t=b(P.breakpoints.up("md")),s=b(P.breakpoints.up("sm"));return W.useEffect(()=>{e?document.documentElement.style.fontSize="16px":s?document.documentElement.style.fontSize="15px":document.documentElement.style.fontSize="13px"},[e,t,s]),{isLg:e,isMd:t,isSm:s}},le=M(u.jsx("path",{d:"M16.88 2.88c-.49-.49-1.28-.49-1.77 0L6.7 11.29c-.39.39-.39 1.02 0 1.41l8.41 8.41c.49.49 1.28.49 1.77 0s.49-1.28 0-1.77L9.54 12l7.35-7.35c.48-.49.48-1.28-.01-1.77"})),de=M(u.jsx("path",{d:"M12 7c.55 0 1 .45 1 1v4c0 .55-.45 1-1 1s-1-.45-1-1V8c0-.55.45-1 1-1m-.01-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8m1-3h-2v-2h2z"})),he=({error:e,resetErrorBoundary:t})=>u.jsxs(S,{sx:{minHeight:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",p:3,bgcolor:"secondary.main",color:"text.primary",textAlign:"center"},children:[u.jsxs(S,{className:"mode-dark",sx:{display:"flex",justifyContent:"center",alignItems:"center",gap:1,mb:4},children:[u.jsx(ne,{color:"primary",sx:{fontSize:"2.5rem"}}),u.jsx(g,{variant:"h4",component:"h1",sx:{color:"text.primary",fontFamily:'"timemachine-wa"'},children:"論壇樣板"})]}),u.jsxs(_,{elevation:4,sx:{p:4,borderRadius:3,maxWidth:"100%",display:"flex",flexDirection:"column",alignItems:"center",gap:2},children:[u.jsx(de,{fontSize:"large",sx:{color:"error.main"}}),u.jsx(g,{variant:"h5",component:"p",gutterBottom:!0,children:"發生錯誤"}),u.jsx(g,{variant:"body1",color:"text.secondary",children:e==null?void 0:e.message}),u.jsx(g,{variant:"body1",color:"text.secondary",children:"很抱歉，頁面載入時發生問題，請稍後再試"}),u.jsxs(S,{sx:{display:"flex",gap:2,mt:2},children:[u.jsx(O,{variant:"contained",href:Q.forum_home,startIcon:u.jsx(le,{}),children:"返回首頁"}),u.jsx(O,{variant:"outlined",onClick:()=>t(),startIcon:u.jsx(Y,{}),children:"重新載入"})]})]}),u.jsxs(g,{className:"mode-dark",variant:"body2",sx:{mt:4,color:"text.secondary"},children:["如需協助，請聯繫",u.jsx(g,{component:"span",variant:"body2",sx:{cursor:"pointer",color:"primary.light","&:hover":{textDecoration:"underline"}},children:" 論壇樣板客服 "})]})]}),fe=new X;function be({children:e}){return u.jsxs(z,{theme:P,children:[u.jsx(J,{}),u.jsx(K,{}),u.jsx(Z,{client:fe,children:u.jsx(ee,{fallbackRender:t=>u.jsx(he,{...t}),children:e})})]})}const q=500,E="sqlite-db-forum";class d{static async exec(t,s,r=!1){const a=Date.now();this.dbPromise=this.dbPromise===null?this.loadDatabase():this.dbPromise;const n=await this.dbPromise;n.run("PRAGMA foreign_keys = ON;");const[{values:o}]=n.exec("PRAGMA foreign_keys;");if(o[0][0]!==1)return console.error("Failed to enable foreign keys"),this.parse([]);const i=await w((async()=>{const l=n.exec(t,s);return await this.saveDatabase(n),l})());if(i.error!==null)return console.error("Failed to execute SQL query",i.error),this.parse([]);const c=Date.now()-a;return c<q&&!r&&await new Promise(l=>setTimeout(l,q-c)),this.parse(i.data)}static async reset(){await te(E),this.dbPromise=this.loadDatabase()}static parse(t){if(t.length===0||!t[0])return[];const{columns:s,values:r}=t[0];return r.map(a=>Object.fromEntries(s.map((n,o)=>[n,a[o]])))}static async loadDatabase(){const t=await se({locateFile:c=>`https://sql.js.org/dist/${c}`}),{data:s,error:r}=await w(re(E));if(r&&console.error("Failed to get cached database",r),s)return new t.Database(s);const{data:a,error:n}=await w((async()=>{const l=await(await fetch(ae)).arrayBuffer();return new t.Database(new Uint8Array(l))})());if(n)return console.error("Failed to fetch database file",n),new t.Database;const o=a.export(),{error:i}=await w(j(E,o));return i&&console.error("Failed to save database to IndexedDB",i),a}static async saveDatabase(t){const s=t.export(),{error:r}=await w(j(E,s));r&&console.error("Failed to save database to IndexedDB",r)}}F(d,"dbPromise",null);const me=async()=>{var s;return((s=(await d.exec(`
      SELECT COUNT(*) as count
      FROM users
    `))[0])==null?void 0:s.count)||0},pe=async({page:e=0,limit:t=10,isAuthor:s=!1,isUnfollowed:r=!1,orderBy:a="createdAt",order:n="desc"}={})=>{var A;let o=null;if(r){const N=await $({server:!0});o=N.authenticated?N.user.id:null}const i=[],c={};s&&i.push("EXISTS (SELECT 1 FROM posts WHERE posts.userId = u.id)"),r&&o&&(i.push(`
  ...
  `,{$userId:s.user.id},e);if(n.length===0)return localStorage.removeItem(m),{authenticated:!1,user:null,loading:!1,error:"使用者不存在"};const o=n[0],i={...s,user:o},c={...i,timestamp:r};return localStorage.setItem(m,JSON.stringify(c)),i},we=async()=>{localStorage.removeItem(m)},Ce=async({username:e,password:t,email:s,description:r=""})=>{if(await I({name:e}))return{authenticated:!1,user:null,loading:!1,error:"使用者名稱已存在"};if(await L({email:s}))return{authenticated:!1,user:null,loading:!1,error:"電子郵件已被使用"};const o=await v(t),i=new Date().toISOString(),l=await d.exec(`
    ...
    `,{$userId:e,$hashedPassword:i,$updatedAt:c}),{...r,error:null}},Fe=async({userId:e})=>{const t=await $({server:!0});return!t.authenticated||t.user.id!==e?{success:!1,error:"未登入或無權限"}:(await d.exec(`
      DELETE FROM users
      WHERE id = $userId
    `,{$userId:e}),await we(),{success:!0,error:null})},R=1*60*1e3,Oe=()=>T({queryKey:["userCounts"],queryFn:me,staleTime:R}),De=({page:e=0,limit:t,isAuthor:s=!0,isUnfollowed:r,orderBy:a,order:n}={})=>ue({queryKey:["users",e,t,s,r,a,n],queryFn:async({pageParam:o})=>pe({page:o,limit:t,isAuthor:s,isUnfollowed:r,orderBy:a,order:n}),initialPageParam:0,getNextPageParam:o=>o.nextPage,staleTime:R}),je=e=>T({queryKey:["user",e],queryFn:()=>e==null?null:I({name:e}),staleTime:R}),qe=e=>T({queryKey:["userStats",e],queryFn:()=>ge({userId:e}),staleTime:R}),ye={position:"relative",height:"100dvh",overflow:"auto",scrollbarWidth:"thin",scrollbarColor:"gray transparent",display:"flex",flexDirection:"column"},Me=({children:e,...t})=>u.jsx(S,{sx:ye,id:"scroll-area",className:"top",onScroll:s=>{const r=s.target;r.scrollTop<25?r.classList.add("top"):r.classList.remove("top")},...t,children:e});export{be as A,Me as S,Re as a,le as b,Oe as c,d,ue as e,je as f,qe as g,Ae as h,Ne as i,Fe as j,Te as k,we as l,$ as m,Ce as r,P as t,De as u};
