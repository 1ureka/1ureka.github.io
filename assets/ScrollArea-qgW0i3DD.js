import{f as j,l as R,r as q,o as M,j as o,p as E,n as g,F as D,B as O,v as L,T as U,C as k,h as H}from"./routes-DrAjfNKu.js";import{i as A,h as W,a as Q,E as B,R as _,Q as z,b as J,c as K}from"./RefreshRounded-Hlj_ZRjd.js";import{F as G}from"./ForumRounded-zIbb3rD6.js";import{Q as V,a as X,S as Y,f as Z,u as v}from"./SQLiteClient-CXu3MqOl.js";var ee=class extends V{constructor(e,s){super(e,s)}bindMethods(){super.bindMethods(),this.fetchNextPage=this.fetchNextPage.bind(this),this.fetchPreviousPage=this.fetchPreviousPage.bind(this)}setOptions(e){super.setOptions({...e,behavior:A()})}getOptimisticResult(e){return e.behavior=A(),super.getOptimisticResult(e)}fetchNextPage(e){return this.fetch({...e,meta:{fetchMore:{direction:"forward"}}})}fetchPreviousPage(e){return this.fetch({...e,meta:{fetchMore:{direction:"backward"}}})}createResult(e,s){var x,S;const{state:t}=e,r=super.createResult(e,s),{isFetching:a,isRefetching:i,isError:n,isRefetchError:u}=r,c=(S=(x=t.fetchMeta)==null?void 0:x.fetchMore)==null?void 0:S.direction,d=n&&c==="forward",h=a&&c==="forward",f=n&&c==="backward",p=a&&c==="backward";return{...r,fetchNextPage:this.fetchNextPage,fetchPreviousPage:this.fetchPreviousPage,hasNextPage:Q(s,t.data),hasPreviousPage:W(s,t.data),isFetchNextPageError:d,isFetchingNextPage:h,isFetchPreviousPageError:f,isFetchingPreviousPage:p,isRefetchError:u&&!d&&!f,isRefetching:i&&!h&&!p}}};function te(e,s){return X(e,ee)}const y=j({cssVariables:{colorSchemeSelector:".mode-%s"},typography:{fontFamily:'Comfortaa, "jf openhuninn"'},colorSchemes:{light:{palette:{text:{primary:"#000"},primary:{main:"#FF772E",contrastText:"#fff"},secondary:{main:"#2f5d6f"}}},dark:{palette:{primary:{main:"#FF772E",contrastText:"#fff"},secondary:{main:"#2f5d6f"},background:{default:"#222",paper:"#222"}}}},components:{MuiInputBase:{defaultProps:{sx:{"&.Mui-disabled::before":{borderBottomStyle:"solid"}}}}},spacing:"0.5rem"}),ge=()=>{const e=R(y.breakpoints.up("lg")),s=R(y.breakpoints.up("md")),t=R(y.breakpoints.up("sm"));return q.useEffect(()=>{e?document.documentElement.style.fontSize="16px":t?document.documentElement.style.fontSize="15px":document.documentElement.style.fontSize="13px"},[e,s,t]),{isLg:e,isMd:s,isSm:t}},se=M(o.jsx("path",{d:"M16.88 2.88c-.49-.49-1.28-.49-1.77 0L6.7 11.29c-.39.39-.39 1.02 0 1.41l8.41 8.41c.49.49 1.28.49 1.77 0s.49-1.28 0-1.77L9.54 12l7.35-7.35c.48-.49.48-1.28-.01-1.77"})),re=({error:e,resetErrorBoundary:s})=>o.jsxs(E,{sx:{minHeight:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",p:3,bgcolor:"secondary.main",color:"text.primary",textAlign:"center"},children:[o.jsxs(E,{className:"mode-dark",sx:{display:"flex",justifyContent:"center",alignItems:"center",gap:1,mb:4},children:[o.jsx(G,{color:"primary",sx:{fontSize:"2.5rem"}}),o.jsx(g,{variant:"h4",component:"h1",sx:{color:"text.primary",fontFamily:'"timemachine-wa"'},children:"論壇樣板"})]}),o.jsxs(D,{elevation:4,sx:{p:4,borderRadius:3,maxWidth:"100%",display:"flex",flexDirection:"column",alignItems:"center",gap:2},children:[o.jsx(B,{fontSize:"large",sx:{color:"error.main"}}),o.jsx(g,{variant:"h5",component:"p",gutterBottom:!0,children:"發生錯誤"}),o.jsx(g,{variant:"body1",color:"text.secondary",children:e==null?void 0:e.message}),o.jsx(g,{variant:"body1",color:"text.secondary",children:"很抱歉，頁面載入時發生問題，請稍後再試"}),o.jsxs(E,{sx:{display:"flex",gap:2,mt:2},children:[o.jsx(O,{variant:"contained",href:L.forum_home,startIcon:o.jsx(se,{}),children:"返回首頁"}),o.jsx(O,{variant:"outlined",onClick:()=>s(),startIcon:o.jsx(_,{}),children:"重新載入"})]})]}),o.jsxs(g,{className:"mode-dark",variant:"body2",sx:{mt:4,color:"text.secondary"},children:["如需協助，請聯繫",o.jsx(g,{component:"span",variant:"body2",sx:{cursor:"pointer",color:"primary.light","&:hover":{textDecoration:"underline"}},children:" 論壇樣板客服 "})]})]}),ae=new z;function xe({children:e}){return o.jsxs(U,{theme:y,children:[o.jsx(k,{}),o.jsx(H,{}),o.jsx(J,{client:ae,children:o.jsx(K,{fallbackRender:s=>o.jsx(re,{...s}),children:e})})]})}const l=new Y({dbPath:Z,storageKey:"sqlite-db-forum"}),ne=async()=>{var t;return((t=(await l.exec(`
    ...
    `),c.$currentUserId=n);const d=u.length>0?`WHERE ${u.join(" AND ")}`:"";let h="u.createdAt";a==="postCount"||a==="followerCount"?h=`uic.${a}`:h=`u.${a}`;const f=`
      ...
      FROM users u
      ${d}
    `,C=((T=(await l.exec(f,c))[0])==null?void 0:T.totalCount)||0,x=Math.ceil(C/s),S=e+1<x?e+1:null;c.$limit=s,c.$offset=e*s;const F=`
  ...
  `,{$userId:t.user.id},e);if(i.length===0)return localStorage.removeItem(m),{authenticated:!1,user:null,loading:!1,error:"使用者不存在"};const n=i[0],u={...t,user:n},c={...u,timestamp:r};return localStorage.setItem(m,JSON.stringify(c)),u},ue=async()=>{localStorage.removeItem(m)},Ee=async({username:e,password:s,email:t,description:r=""})=>{if(await P({name:e}))return{authenticated:!1,user:null,loading:!1,error:"使用者名稱已存在"};if(await b({email:t}))return{authenticated:!1,user:null,loading:!1,error:"電子郵件已被使用"};const n=await w(s),u=new Date().toISOString(),d=await l.exec(`
    ...
    `,{$name:e,$email:t,$hashedPassword:n,$description:r,$createdAt:u,$updatedAt:u});if(!d||d.length===0)return{authenticated:!1,user:null,loading:!1,error:"註冊失敗"};const f={authenticated:!0,user:d[0],loading:!1,error:null},p={...f,timestamp:Date.now()};return localStorage.setItem(m,JSON.stringify(p)),f},ye=async({userId:e,username:s,email:t,description:r})=>{const a=await $({server:!0});if(!a.authenticated||a.user.id!==e)return{authenticated:!1,user:null,loading:!1,error:"未登入或無權限"};if(!s&&!t&&r===void 0)return{...a,error:"沒有要更新的欄位"};if(s===a.user.name&&t===a.user.email&&r===a.user.description)return{...a,error:"個人資料沒有任何變更需要更新"};if(s&&s!==a.user.name&&await P({name:s}))return{...a,error:"使用者名稱已存在"};if(t&&t!==a.user.email&&await b({email:t}))return{...a,error:"電子郵件已被使用"};const i=[],n={$userId:e};s&&(i.push("name = $username"),n.$username=s),t&&(i.push("email = $email"),n.$email=t),r!==void 0&&(i.push("description = $description"),n.$description=r),i.push("updatedAt = $updatedAt"),n.$updatedAt=new Date().toISOString();const u=`
      UPDATE users
      SET ${i.join(", ")}
      WHERE id = $userId
      RETURNING id, name, email, description
    `,c=await l.exec(u,n);if(!c||c.length===0)return{...a,error:"更新失敗"};const h={authenticated:!0,user:c[0],loading:!1,error:null},f={...h,timestamp:Date.now()};return localStorage.setItem(m,JSON.stringify(f)),h},we=async({userId:e,currentPassword:s,newPassword:t})=>{const r=await $({server:!0});if(!r.authenticated||r.user.id!==e)return{authenticated:!1,user:null,loading:!1,error:"未登入或無權限"};const a=await w(s);if((await l.exec(`
      SELECT id
      FROM users
    ...
    `,{$userId:e,$hashedPassword:a})).length===0)return{...r,error:"當前密碼錯誤"};const u=await w(t),c=new Date().toISOString();return await l.exec(`
      ...
      SET hashedPassword = $hashedPassword,
          updatedAt = $updatedAt
      WHERE id = $userId
    `,{$userId:e,$hashedPassword:u,$updatedAt:c}),{...r,error:null}},Pe=async({userId:e})=>{const s=await $({server:!0});return!s.authenticated||s.user.id!==e?{success:!1,error:"未登入或無權限"}:(await l.exec(`
      DELETE FROM users
      WHERE id = $userId
    `,{$userId:e}),await ue(),{success:!0,error:null})},I=1*60*1e3,$e=()=>v({queryKey:["userCounts"],queryFn:ne,staleTime:I}),Ie=({page:e=0,limit:s,isAuthor:t=!0,isUnfollowed:r,orderBy:a,order:i}={})=>te({queryKey:["users",e,s,t,r,a,i],queryFn:async({pageParam:n})=>oe({page:n,limit:s,isAuthor:t,isUnfollowed:r,orderBy:a,order:i}),initialPageParam:0,getNextPageParam:n=>n.nextPage,staleTime:I}),Re=e=>v({queryKey:["user",e],queryFn:()=>e==null?null:P({name:e}),staleTime:I}),ve=e=>v({queryKey:["userStats",e],queryFn:()=>ie({userId:e}),staleTime:I}),le={position:"relative",height:"100dvh",overflow:"auto",scrollbarWidth:"thin",scrollbarColor:"gray transparent",display:"flex",flexDirection:"column"},Ce=({children:e,...s})=>o.jsx(E,{sx:le,id:"scroll-area",className:"top",onScroll:t=>{const r=t.target;r.scrollTop<25?r.classList.add("top"):r.classList.remove("top")},...s,children:e});export{xe as A,Ce as S,ge as a,se as b,$e as c,te as d,Re as e,ve as f,$ as g,ye as h,we as i,Pe as j,Se as k,ue as l,Ee as r,l as s,y as t,Ie as u};
