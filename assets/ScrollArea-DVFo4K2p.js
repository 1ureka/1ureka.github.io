import{f as j,i as R,r as q,n as M,j as o,o as E,l as g,A as D,B as O,w as L,T as U,C as k,h as H}from"./routes-BRvtlvXq.js";import{i as A,h as W,a as Q,E as B,R as _,Q as z,b as J,c as K}from"./RefreshRounded-BM5m51hi.js";import{F as G}from"./ForumRounded-DtKYxlCC.js";import{Q as V,a as X,S as Y,f as Z,u as v}from"./SQLiteClient-ClFa2ebI.js";var ee=class extends V{constructor(e,t){super(e,t)}bindMethods(){super.bindMethods(),this.fetchNextPage=this.fetchNextPage.bind(this),this.fetchPreviousPage=this.fetchPreviousPage.bind(this)}setOptions(e,t){super.setOptions({...e,behavior:A()},t)}getOptimisticResult(e){return e.behavior=A(),super.getOptimisticResult(e)}fetchNextPage(e){return this.fetch({...e,meta:{fetchMore:{direction:"forward"}}})}fetchPreviousPage(e){return this.fetch({...e,meta:{fetchMore:{direction:"backward"}}})}createResult(e,t){var x,S;const{state:s}=e,r=super.createResult(e,t),{isFetching:a,isRefetching:i,isError:n,isRefetchError:u}=r,c=(S=(x=s.fetchMeta)==null?void 0:x.fetchMore)==null?void 0:S.direction,d=n&&c==="forward",h=a&&c==="forward",f=n&&c==="backward",p=a&&c==="backward";return{...r,fetchNextPage:this.fetchNextPage,fetchPreviousPage:this.fetchPreviousPage,hasNextPage:Q(t,s.data),hasPreviousPage:W(t,s.data),isFetchNextPageError:d,isFetchingNextPage:h,isFetchPreviousPageError:f,isFetchingPreviousPage:p,isRefetchError:u&&!d&&!f,isRefetching:i&&!h&&!p}}};function te(e,t){return X(e,ee)}const y=j({cssVariables:{colorSchemeSelector:".mode-%s"},typography:{fontFamily:'Comfortaa, "jf openhuninn"'},colorSchemes:{light:{palette:{text:{primary:"#000"},primary:{main:"#FF772E",contrastText:"#fff"},secondary:{main:"#2f5d6f"}}},dark:{palette:{primary:{main:"#FF772E",contrastText:"#fff"},secondary:{main:"#2f5d6f"},background:{default:"#222",paper:"#222"}}}},components:{MuiInputBase:{defaultProps:{sx:{"&.Mui-disabled::before":{borderBottomStyle:"solid"}}}}},spacing:"0.5rem"}),ge=()=>{const e=R(y.breakpoints.up("lg")),t=R(y.breakpoints.up("md")),s=R(y.breakpoints.up("sm"));return q.useEffect(()=>{e?document.documentElement.style.fontSize="16px":s?document.documentElement.style.fontSize="15px":document.documentElement.style.fontSize="13px"},[e,t,s]),{isLg:e,isMd:t,isSm:s}},se=M(o.jsx("path",{d:"M16.88 2.88c-.49-.49-1.28-.49-1.77 0L6.7 11.29c-.39.39-.39 1.02 0 1.41l8.41 8.41c.49.49 1.28.49 1.77 0s.49-1.28 0-1.77L9.54 12l7.35-7.35c.48-.49.48-1.28-.01-1.77"})),re=({error:e,resetErrorBoundary:t})=>o.jsxs(E,{sx:{minHeight:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",p:3,bgcolor:"secondary.main",color:"text.primary",textAlign:"center"},children:[o.jsxs(E,{className:"mode-dark",sx:{display:"flex",justifyContent:"center",alignItems:"center",gap:1,mb:4},children:[o.jsx(G,{color:"primary",sx:{fontSize:"2.5rem"}}),o.jsx(g,{variant:"h4",component:"h1",sx:{color:"text.primary",fontFamily:'"timemachine-wa"'},children:"論壇樣板"})]}),o.jsxs(D,{elevation:4,sx:{p:4,borderRadius:3,maxWidth:"100%",display:"flex",flexDirection:"column",alignItems:"center",gap:2},children:[o.jsx(B,{fontSize:"large",sx:{color:"error.main"}}),o.jsx(g,{variant:"h5",component:"p",gutterBottom:!0,children:"發生錯誤"}),o.jsx(g,{variant:"body1",color:"text.secondary",children:e==null?void 0:e.message}),o.jsx(g,{variant:"body1",color:"text.secondary",children:"很抱歉，頁面載入時發生問題，請稍後再試"}),o.jsxs(E,{sx:{display:"flex",gap:2,mt:2},children:[o.jsx(O,{variant:"contained",href:L.forum_home,startIcon:o.jsx(se,{}),children:"返回首頁"}),o.jsx(O,{variant:"outlined",onClick:()=>t(),startIcon:o.jsx(_,{}),children:"重新載入"})]})]}),o.jsxs(g,{className:"mode-dark",variant:"body2",sx:{mt:4,color:"text.secondary"},children:["如需協助，請聯繫",o.jsx(g,{component:"span",variant:"body2",sx:{cursor:"pointer",color:"primary.light","&:hover":{textDecoration:"underline"}},children:" 論壇樣板客服 "})]})]}),ae=new z;function xe({children:e}){return o.jsxs(U,{theme:y,children:[o.jsx(k,{}),o.jsx(H,{}),o.jsx(J,{client:ae,children:o.jsx(K,{fallbackRender:t=>o.jsx(re,{...t}),children:e})})]})}const l=new Y({dbPath:Z,storageKey:"sqlite-db-forum"}),ne=async()=>{var s;return((s=(await l.exec(`
    ...
    `),c.$currentUserId=n);const d=u.length>0?`WHERE ${u.join(" AND ")}`:"";let h="u.createdAt";a==="postCount"||a==="followerCount"?h=`uic.${a}`:h=`u.${a}`;const f=`
      ...
      FROM users u
      ${d}
    `,C=((T=(await l.exec(f,c))[0])==null?void 0:T.totalCount)||0,x=Math.ceil(C/t),S=e+1<x?e+1:null;c.$limit=t,c.$offset=e*t;const F=`
    ...
    `;return{users:await l.exec(F,c),nextPage:S,totalPages:x}},P=async({name:e})=>{const s=await l.exec(`
  ...
  `,{$userId:s.user.id},e);if(i.length===0)return localStorage.removeItem(m),{authenticated:!1,user:null,loading:!1,error:"使用者不存在"};const n=i[0],u={...s,user:n},c={...u,timestamp:r};return localStorage.setItem(m,JSON.stringify(c)),u},ue=async()=>{localStorage.removeItem(m)},Ee=async({username:e,password:t,email:s,description:r=""})=>{if(await P({name:e}))return{authenticated:!1,user:null,loading:!1,error:"使用者名稱已存在"};if(await b({email:s}))return{authenticated:!1,user:null,loading:!1,error:"電子郵件已被使用"};const n=await w(t),u=new Date().toISOString(),d=await l.exec(`
    ...
    `,{$userId:e,$hashedPassword:a})).length===0)return{...r,error:"當前密碼錯誤"};const u=await w(s),c=new Date().toISOString();return await l.exec(`
      ...
      SET hashedPassword = $hashedPassword,
          updatedAt = $updatedAt
      WHERE id = $userId
    `,{$userId:e,$hashedPassword:u,$updatedAt:c}),{...r,error:null}},Pe=async({userId:e})=>{const t=await $({server:!0});return!t.authenticated||t.user.id!==e?{success:!1,error:"未登入或無權限"}:(await l.exec(`
      DELETE FROM users
      WHERE id = $userId
    `,{$userId:e}),await ue(),{success:!0,error:null})},I=1*60*1e3,$e=()=>v({queryKey:["userCounts"],queryFn:ne,staleTime:I}),Ie=({page:e=0,limit:t,isAuthor:s=!0,isUnfollowed:r,orderBy:a,order:i}={})=>te({queryKey:["users",e,t,s,r,a,i],queryFn:async({pageParam:n})=>oe({page:n,limit:t,isAuthor:s,isUnfollowed:r,orderBy:a,order:i}),initialPageParam:0,getNextPageParam:n=>n.nextPage,staleTime:I}),Re=e=>v({queryKey:["user",e],queryFn:()=>e==null?null:P({name:e}),staleTime:I}),ve=e=>v({queryKey:["userStats",e],queryFn:()=>ie({userId:e}),staleTime:I}),le={position:"relative",height:"100dvh",overflow:"auto",scrollbarWidth:"thin",scrollbarColor:"gray transparent",display:"flex",flexDirection:"column"},Ce=({children:e,...t})=>o.jsx(E,{sx:le,id:"scroll-area",className:"top",onScroll:s=>{const r=s.target;r.scrollTop<25?r.classList.add("top"):r.classList.remove("top")},...t,children:e});export{xe as A,Ce as S,ge as a,se as b,$e as c,te as d,Re as e,ve as f,$ as g,ye as h,we as i,Pe as j,Se as k,ue as l,Ee as r,l as s,y as t,Ie as u};
